  ...
  return (
    <section id="vini" className="bg-ink text-white py-14 md:py-16 overflow-hidden">
      <div className="mx-auto max-w-3xl px-6 md:px-10 flex flex-col items-center text-center">
        {/* Foto entre o texto da seção "Sobre" e o nome do Vini, em todas as
            telas — sem inversão de ordem entre mobile/desktop. */}
        <div
          ref={imgRef}
          className="reveal relative w-full max-w-xs sm:max-w-sm aspect-[4/5] overflow-hidden bg-ink"
        >
          <img
            src={images.vini}
            alt={founder.name}
        ...
        <div ref={textRef} className="reveal mt-10">
        ...
        <div ref={certsRef} className="reveal mt-10 w-full">
          <p
