  ...
  return (
    <section className="bg-paper py-16 md:py-24 px-6">
      <div ref={ref} className="reveal mx-auto max-w-3xl text-center">
        <p className="text-xs tracking-[0.4em] text-graphite mb-4">SOBRE A REVOM</p>
        <h2 className="font-display text-ink leading-[0.95] text-[10vw] sm:text-5xl md:text-6xl">
          Nascemos da paixão pelo detalhe.
        </h2>
        <p className="mt-8 text-graphite text-base md:text-lg font-light max-w-xl mx-auto leading-relaxed">
        ...
        <p className="mt-6 text-graphite text-base md:text-lg font-light max-w-xl mx-auto leading-relaxed">
